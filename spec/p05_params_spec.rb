...
describe Monastery::Params do
  ...
  it "handles an empty request" do
    expect { Monastery::Params.new(req) }.to_not raise_error
  end

  context "query string" do
    it "handles single key and value" do
      req.query_string = "key=val"
      params = Monastery::Params.new(req)
  ...
  context "route params" do
    it "handles route params" do
      params = Monastery::Params.new(req, {"id" => 5, "user_id" => 22})
  ...
  context "indifferent access" do
    it "responds to string and symbol keys" do
      params = Monastery::Params.new(req, {"id" => 5})
      expect(params["id"]).to eq(5)
      expect(params[:id]).to eq(5)
    end
  end
  ...
  #       expect { params.require("key2") }.to raise_error(Monastery::Params::AttributeNotFoundError)
  #     end
  #   end
  #
